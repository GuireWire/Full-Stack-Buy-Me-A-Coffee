...
def deploy_coffee(eth_price_feed: VyperContract, link_price_feed: VyperContract, link_token: VyperContract) -> VyperContract:
    ...
    coffee: VyperContract = buy_me_a_coffee.deploy(
