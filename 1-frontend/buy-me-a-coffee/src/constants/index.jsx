export const features = [
  {
    ...
    title: "Support Smarter, Not Harder",
    text: "With Buy Me A Coffee, supporting GuireWire is a breeze. Powered by Web3 technology, connecting your wallet and making contributions is seamless, secure, and hassle-free. It's as easy as buying a coffee but far more impactful.",
    button: {
  ...
  },
  {
    ...
    title: "Your Support, Secured with zkSync",
    text: "Every contribution is recorded on the blockchain, ensuring full transparency and privacy. Built on zkSync Sepolia, your transactions are lightning-fast, secure, and free from third-party interference.",
    button: {
      icon: "/images/docs.svg",
      title: "Read Web3 Articles",
      scrollTo: "articles"
    },
  },
];
...
export const details = [
  ...
  },
  {
    ...
    title: "Low Gas Fees with zkSync",
  },
  {
    id: "3",
...
export const articles = [
  {
    id: "0",
    question: "An Introduction to the Web3 World - Blockchain, Smart Contracts",
    answer:
      "From Bitcoin's genesis to Ethereum's smart contracts, demystify the foundational pillars of Web3. Discover how these revolutionary technologies are transforming our digital interactions, and learn why blockchain's promise of decentralization could reshape everything from finance to governance. Perfect for both newcomers and those looking to deepen their Web3 understanding.",
    substackUrl: "https://open.substack.com/pub/guirewire/p/an-introduction-to-the-web3-world?r=45vowb&utm_campaign=post&utm_medium=web&showWelcomeOnShare=false",
  },
  {
    id: "1",
    question: "L2s: The Key to Ethereum’s Scalable, Sustainable Future",
    answer:
      "Dive into the world of Layer 2 solutions - the key to solving Ethereum's scalability challenge. Explore how innovations like Optimistic and Zero-Knowledge Rollups are revolutionizing blockchain speed and efficiency while maintaining security. From zkSync to StarkNet, discover how these technologies are shaping the future of Ethereum and Web3.",
    substackUrl: "https://open.substack.com/pub/guirewire/p/l2s-the-key-to-ethereums-scalable?r=45vowb&utm_campaign=post&utm_medium=web&showWelcomeOnShare=false",
  }
];
...
export const plans = [
  {
    ...
    PriceETH: 5,
    PriceLINK: 3,
    caption: "Buy Me 1 Coffee to keep me caffeinated and motivated!",
    features: [
      "A personal thank you",
      "Early access to my updates",
  ...
  },
  {
    ...
    PriceETH: 10,
    PriceLINK: 7,
    caption: "Buy Me 2 Coffees to help fuel my creativity!",
    features: [
      "Everything in Small Cup",
      "Exclusive behind-the-scenes content",
      "Monthly Q&A or private updates",
    ],
  ...
  },
  {
    ...
    PriceETH: 15,
    PriceLINK: 12,
    caption: "Buy Me 3 Coffees to supercharge my work!",
    features: [
      "Everything in Medium Cup",
      "Personalized shoutout or thank-you video",
      "Early access to premium projects/content",
    ],
...
export const testimonials = [
  {
    ...
    name: "GuireWire",
    role: "Guire Academy",
    avatarUrl: "/images/testimonials/guire.png",
    comment:
      "Integrating zkSync with Buy Me A Coffee is brilliant! The low gas fees and instant transactions make supporting content creators actually practical. It's exactly what Web3 needs - making blockchain technology accessible and useful for everyday interactions.",
  },
  {
    id: "1",
    name: "Future Builder Spotlight",
    role: "Add Your Voice",
    avatarUrl: "/images/testimonials/yourvoice.png",
    comment:
      "Share Your Story. Be part of our growing Web3 community. Share your experience and help shape the future of Web3.",
  },
];
